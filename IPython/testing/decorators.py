...
def apply_wrapper(wrapper, func):
    ...
    """
    warnings.warn(
        "The function `apply_wrapper` is deprecated since IPython 4.0",
        DeprecationWarning,
        stacklevel=2,
    )
    import nose.tools
...
def make_label_dec(label, ds=None):
    ...
    warnings.warn(
        "The function `make_label_dec` is deprecated since IPython 4.0",
        DeprecationWarning,
        stacklevel=2,
    )
...
def decorated_dummy(dec, name):
    ...
    """
    warnings.warn(
        "The function `decorated_dummy` is deprecated since IPython 4.0",
        DeprecationWarning,
        stacklevel=2,
    )
    dummy = lambda: None
