...
from IPython.core.inputtransformer2 import ESC_MAGIC, ESC_QUOTE, ESC_QUOTE2, ESC_PAREN
...
class PrefilterManager(Configurable):
    ...
    def init_transformers(self):
        ...
        for transformer_cls in _default_transformers:
            transformer_cls(shell=self.shell, prefilter_manager=self, parent=self)
