...
class IPCompleter(Completer):
    ...
    dict_keys_only = Bool(False, help="""Whether to show dict key matches only""")
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.magic_arg_matchers = [self.magic_config_matches, self.magic_color_matches]
    ...
    def all_completions(self, text) -> List[str]:
        ...
        with provisionalcompleter():
            return [
                ".".join([prefix, c.text]) if prefix and self.use_jedi else c.text
