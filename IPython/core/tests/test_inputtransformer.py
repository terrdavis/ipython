...
syntax = dict(
    ...
    end_help=[
        ...
        for i, o in [
            ...
            (
                u"a = abc?",
                "get_ipython().set_next_input('a = abc');"
                "get_ipython().run_line_magic('pinfo', 'abc')",
            ),
            (
                u"a = abc.qe??",
                "get_ipython().set_next_input('a = abc.qe');"
                "get_ipython().run_line_magic('pinfo2', 'abc.qe')",
            ),
            (
                u"a = *.items?",
                "get_ipython().set_next_input('a = *.items');"
                "get_ipython().run_line_magic('psearch', '*.items')",
            ),
            (
                u"plot(a?",
                "get_ipython().set_next_input('plot(a');"
...
syntax_ml = dict(
    ...
    ipy_prompt=[
        ...
        [('In [2]: a="""', 'a="""'), ('   ...: 123"""', '123"""')],
        [('a="""', 'a="""'), ("   ...: 123", "123"), ('   ...: 456"""', '456"""')],
        [('a="""', 'a="""'), ("In [1]: 123", "123"), ('   ...: 456"""', '456"""')],
        [('a="""', 'a="""'), ("123", "123"), ('   ...: 456"""', '   ...: 456"""')],
    ],
    multiline_datastructure_prompt=[[(">>> a = [1,", "a = [1,"), ("... 2]", "2]")]],
    ...
    multiline_string=[[("'''foo?", None), ("bar'''", "'''foo?\nbar'''")]],
    leading_indent=[
        [('    print "hi"', 'print "hi"')],
        [("  for a in range(5):", "for a in range(5):"), ("    a*2", "  a*2")],
        [('    a="""', 'a="""'), ('    123"""', '123"""')],
        [('a="""', 'a="""'), ('    123"""', '    123"""')],
    ],
    cellmagic=[
        ...
        [(u"a=5", "a=5"), (u"%%cellmagic", "%%cellmagic")],
    ],
    escaped=[
        [
            ("%abc def \\", None),
...
def test_classic_prompt():
    ...
    # IPython syntax
    transform_checker([(u"%foo", "%foo"), (u">>> bar", ">>> bar")], ipt.classic_prompt)
...
def test_ipy_prompt():
    ...
    transform_checker(
        [(u"%%foo", "%%foo"), (u"In [1]: bar", "In [1]: bar")], ipt.ipy_prompt
    )


def test_assemble_logical_lines():
    tests = [
        [(u"a = \\", None), (u"123", u"a = 123")],
        [
...
def test_token_input_transformer():
    tests = [(u"1.2", u_fmt(u"Decimal ('1.2')")), (u'"1.2"', u'"1.2"')]
    ...
    ml_tests = [
        ...
        [(u"a = [1.2,", None), (u"3]", u_fmt(u"a =[Decimal ('1.2'),\n3 ]"))],
        [
